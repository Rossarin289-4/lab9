...
public class AccountController{
    ...
    public AccountController(AccountService accountService, DepositRepository depositRepository, DepositService depositService){
    ...
    @PostMapping
    public Account creAccount(@RequestBody Account account){
    ...
    public ResponseEntity<?> deposit(@PathVariable Long id, @RequestBody  Map<String, Double> request){
        ...
        return ResponseEntity.ok(Map.of("message", "Desposit successful"));
    }
